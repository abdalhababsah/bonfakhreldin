                ...
                <div id="footer-top-container" class="d-flex flex-wrap align-items-center justify-content-between">
                    <div class="">
                        <div class="footer-widget">
                            <img loading="lazy" src="{{ asset('assets/images/logo/Logo-Bonfakhrladin.png') }}"
                                alt="site logo" width="198" height="70" class="mb-3">
                        </div>
                    </div>
                    <div class="">
                        <div class="footer-widget">
                    ...
                    <div class="col-md-auto col-12 text-center">
                        <p class="footer-copyright mb-0">
                            {{ __('footer.copyright') }} <b class="text-primary">
                                <a style="color: #C7A17A;" target="_blank" href="https://thirtysix36.com/">ThirtySix</a>
