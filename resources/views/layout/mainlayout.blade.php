...
<head>
    ...
    <meta name="keywords"
      content="قهوة, قهوة فخر الدين, بن فخر الدين, أفضل قهوة في الأردن, محمصة القهوة, مقهى, رحلة القهوة, قيم القهوة, fakher aldeen coffee, fakher aldeen, coffee, bonfakhreldin, bon, @yield('meta_keywords')" />
    @yield('meta')
    <meta property="description" content="@yield('meta_description', 'اكتشف رحلة قهوة فخر الدين، شبكتنا المزدهرة التي تضم أكثر من 25 فرعاً في الأردن. نحن ملتزمون بتقديم أفضل أنواع القهوة المحمصة بعناية لنكون جزءاً من يومك.')">
    ...
    <meta property="og:title" content="bon fakhreldin - @yield('title', 'Coffee Shop')">
    <meta property="og:description" content="@yield('meta_description', 'اكتشف رحلة قهوة فخر الدين، شبكتنا المزدهرة التي تضم أكثر من 25 فرعاً في الأردن. نحن ملتزمون بتقديم أفضل أنواع القهوة المحمصة بعناية لنكون جزءاً من يومك.')">
    ...
    <meta name="twitter:title" content="bon fakhreldin - @yield('title', 'Coffee Shop')">
    <meta name="twitter:description" content="@yield('meta_description', 'اكتشف رحلة قهوة فخر الدين، شبكتنا المزدهرة التي تضم أكثر من 25 فرعاً في الأردن. نحن ملتزمون بتقديم أفضل أنواع القهوة المحمصة بعناية لنكون جزءاً من يومك.')">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "@yield('description', 'اكتشف رحلة قهوة فخر الدين، شبكتنا المزدهرة التي تضم أكثر من 25 فرعاً في الأردن. نحن ملتزمون بتقديم أفضل أنواع القهوة المحمصة بعناية لنكون جزءاً من يومك.')",
      "address": {
        "@type": "PostalAddress",
